...
plot(hpc$dtime, hpc$Sub_metering_1, type = "l", xlab = "", ylab = "Energy sub metering")
points(hpc$dtime, hpc$Sub_metering_2, type = "l", col="red", xlab = "", ylab = "Energy sub metering")
points(hpc$dtime, hpc$Sub_metering_3, type = "l", col="blue", xlab = "", ylab = "Energy sub metering" )
